 ...
 *                                                                                                  *
 * file    : ../LiteDTUv2_0_AUTOTMR/1_LDTU_Baseline_subtraction_NoRegTMR.v                          *
 *                                                                                                  *
 * user    : soldi                                                                                  *
 * host    : elt159xl.to.infn.it                                                                    *
 * date    : 07/03/2021 17:10:24                                                                    *
 *                                                                                                  *
 ...
 *                                                                                                  *
 * src file: 1_LDTU_Baseline_subtraction_NoReg.v                                                    *
 *           File is NOT under version control!                                                     *
 *           Modification time : 2021-03-07 16:29:12.710306                                         *
 *           File Size         : 2465                                                               *
 *           MD5 hash          : 0ef5c06eb0cb21ea06e459a34c3cca3a                                   *
 *                                                                                                  *
 ****************************************************************************************************/
...
wire [Nbits_12-1:0] dg01_synchA;
wire [Nbits_12-1:0] dg01_synchB;
wire [Nbits_12-1:0] dg01_synchC;
wire [Nbits_12-1:0] dg10_synchA;
wire [Nbits_12-1:0] dg10_synchB;
wire [Nbits_12-1:0] dg10_synchC;
...
assign dg01_synchA =  d_g01A-b_val_g01A;
assign dg01_synchB =  d_g01B-b_val_g01B;
assign dg01_synchC =  d_g01C-b_val_g01C;
assign dg10_synchA =  d_g10A-b_val_g10A;
assign dg10_synchB =  d_g10B-b_val_g10B;
assign dg10_synchC =  d_g10C-b_val_g10C;
