 ...
 *                                                                                                  *
 * file    : ../LiteDTUv2_0_AUTOTMR/4_LDTU_CU_NewTMR.v                                              *
 *                                                                                                  *
 * user    : soldi                                                                                  *
 * host    : elt159xl.to.infn.it                                                                    *
 * date    : 05/03/2021 21:11:44                                                                    *
 *                                                                                                  *
 * workdir : /export/elt159xl/disk0/users/soldi/LiTE-DTU_v2.0_2021_Simulations/pre-synth/LiteDTUv2_0_NoTMR *
 * cmd     : /export/elt159xl/disk0/users/soldi/LiTE-DTU_v2.0_2021_Simulations/tmrg/bin/tmrg -c     *
 *           tmr_Config/4_LDTU_CU.cfg --tmr-dir=../LiteDTUv2_0_AUTOTMR/                             *
 * tmrg rev: ececa199b20e3753893c07f87ef839ce926b269f                                               *
 *                                                                                                  *
 * src file: 4_LDTU_CU_New.v                                                                        *
 *           File is NOT under version control!                                                     *
 *           Modification time : 2021-03-05 21:11:41.004724                                         *
 *           File Size         : 7644                                                               *
 *           MD5 hash          : bd13ac3e28b484365a6e7bfdc7a2b5a2                                   *
 *                                                                                                  *
 ****************************************************************************************************/
...
reg  read_signal_synchA;
reg  read_signal_synchB;
reg  read_signal_synchC;
reg  losing_data_synchA;
reg  losing_data_synchB;
reg  losing_data_synchC;
reg  write_signal_synchA;
reg  write_signal_synchB;
reg  write_signal_synchC;
reg  [Nbits_32-1:0] DATA_from_CU_synchA;
reg  [Nbits_32-1:0] DATA_from_CU_synchB;
reg  [Nbits_32-1:0] DATA_from_CU_synchC;
...
always @( posedge CLKA )
  begin
    read_signal_synchA <= r_read_signalA;
    write_signal_synchA <= r_write_signalA;
    losing_data_synchA <= r_losing_dataA;
    DATA_from_CU_synchA <= r_DATA_from_CUA;
  end

always @( posedge CLKB )
  begin
    read_signal_synchB <= r_read_signalB;
    write_signal_synchB <= r_write_signalB;
    losing_data_synchB <= r_losing_dataB;
    DATA_from_CU_synchB <= r_DATA_from_CUB;
  end

always @( posedge CLKC )
  begin
    read_signal_synchC <= r_read_signalC;
    write_signal_synchC <= r_write_signalC;
    losing_data_synchC <= r_losing_dataC;
    DATA_from_CU_synchC <= r_DATA_from_CUC;
  end
