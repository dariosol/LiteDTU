 ...
 *                                                                                                  *
 * file    : ./SyncUnit_v1bTMR.v                                                                    *
 *                                                                                                  *
 * user    : gpm                                                                                    *
 * host    : df136xl.ph.unito.it                                                                    *
 * date    : 04/03/2020 15:33:56                                                                    *
 *                                                                                                  *
 * workdir : /export/elt54xl/disk0/users/gpm/projects/LiTE-DTU/syn_v1b/netlist_in                   *
 * cmd     : /export/elt54xl/disk0/users/gpm/projects/LiTE-DTU/tmrg/bin/tmrg --sdc-generate --sdc-  *
 *           headers --config SyncUnit_v1b.cfg SyncUnit_v1b.v                                       *
 * tmrg rev: 9a6ee4d64fce05b58c62ee9ecfc4ef5a8551d404                                               *
 *                                                                                                  *
 * src file: SyncUnit_v1b.v                                                                         *
 *           File is NOT under version control!                                                     *
 *           Modification time : 2020-03-04 15:33:41.550804                                         *
 *           File Size         : 7383                                                               *
 *           MD5 hash          : 12684d4b3677e932e8b122207c6b3172                                   *
 *                                                                                                  *
 ****************************************************************************************************/

module SyncUnit_v1bTMR #(
...
parameter    rd_load=2'b01;
parameter    rd_wait=2'b11;
parameter    dec_idle=4'b0000;
parameter    dec_aHr=4'b0001;
parameter    dec_aLr=4'b0010;
parameter    dec_DTUr=4'b0011;
parameter    dec_I2Cr=4'b0100;
parameter    dec_ATUr=4'b0101;
parameter    dec_aHc=4'b0110;
parameter    dec_aLc=4'b0111;
parameter    dec_wait=4'b1111;
parameter    start=8'b00000111;
parameter    stop=8'b00000000;
parameter    dtu_rst=4'b0010;
parameter    i2c_rst=4'b0011;
parameter    atu_rst=4'b0100;
parameter    adcH_rst=4'b1000;
parameter    adcH_cal=4'b1001;
parameter    adcL_rst=4'b1010;
parameter    adcL_cal=4'b1011;
wire [9:0] TmrErrInC;
wire [9:0] TmrErrInB;
wire [9:0] TmrErrInA;
...
assign int_TmrErrOutA =  TmrErrInA[9] |TmrErrInA[8] |TmrErrInA[7] |TmrErrInA[6] |TmrErrInA[5] |TmrErrInA[4] |TmrErrInA[3] |TmrErrInA[2] |TmrErrInA[1] |TmrErrInA[0] ;
assign int_TmrErrOutB =  TmrErrInB[9] |TmrErrInB[8] |TmrErrInB[7] |TmrErrInB[6] |TmrErrInB[5] |TmrErrInB[4] |TmrErrInB[3] |TmrErrInB[2] |TmrErrInB[1] |TmrErrInB[0] ;
assign int_TmrErrOutC =  TmrErrInC[9] |TmrErrInC[8] |TmrErrInC[7] |TmrErrInC[6] |TmrErrInC[5] |TmrErrInC[4] |TmrErrInC[3] |TmrErrInC[2] |TmrErrInC[1] |TmrErrInC[0] ;
...
always @( cState0A or ShiftRegisterA or DecoderOutA or cnt_eocA )
  begin
    cnt_rstA =  1'b1;
    IR_loadA =  1'b0;
    case (cState0A)
...
always @( cState0B or ShiftRegisterB or DecoderOutB or cnt_eocB )
  begin
    cnt_rstB =  1'b1;
    IR_loadB =  1'b0;
    case (cState0B)
...
always @( cState0C or ShiftRegisterC or DecoderOutC or cnt_eocC )
  begin
    cnt_rstC =  1'b1;
    IR_loadC =  1'b0;
    case (cState0C)
...
always @( cState0A or cState1A or InstrRegA or cnt_eocA )
  begin
    AdcRst_bA =  2'b11;
    AdcIntCalA =  2'b00;
    DtuRst_bA =  1'b1;
...
always @( cState0B or cState1B or InstrRegB or cnt_eocB )
  begin
    AdcRst_bB =  2'b11;
    AdcIntCalB =  2'b00;
    DtuRst_bB =  1'b1;
...
always @( cState0C or cState1C or InstrRegC or cnt_eocC )
  begin
    AdcRst_bC =  2'b11;
    AdcIntCalC =  2'b00;
    DtuRst_bC =  1'b1;
...
SU_fout #(.WIDTH(10)) TmrErrInFanout (
    .in(TmrErrIn),
    .outA(TmrErrInA),
    .outB(TmrErrInB),
    .outC(TmrErrInC)
...
// /export/elt54xl/disk0/users/gpm/projects/LiTE-DTU/tmrg/src/../common/voter.v
...
// /export/elt54xl/disk0/users/gpm/projects/LiTE-DTU/tmrg/src/../common/SU_fout.v
