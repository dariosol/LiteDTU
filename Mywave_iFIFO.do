...
add wave -noupdate /tb_LDTU_presynth/toptoplevel/top_level_LiTE_DTU/Selection_TMR/RefSample2
add wave -noupdate /tb_LDTU_presynth/toptoplevel/top_level_LiTE_DTU/Selection_TMR/SATval_A
add wave -noupdate /tb_LDTU_presynth/toptoplevel/top_level_LiTE_DTU/Selection_TMR/GAIN_SEL_MODE_A
add wave -noupdate /tb_LDTU_presynth/toptoplevel/top_level_LiTE_DTU/Selection_TMR/FIFO_g1_A
add wave -noupdate /tb_LDTU_presynth/toptoplevel/top_level_LiTE_DTU/Selection_TMR/FIFO_g10_A
add wave -noupdate /tb_LDTU_presynth/toptoplevel/top_level_LiTE_DTU/Selection_TMR/FIFO_g10_ref_A
add wave -noupdate /tb_LDTU_presynth/toptoplevel/top_level_LiTE_DTU/Selection_TMR/ref_ptr_A
add wave -noupdate /tb_LDTU_presynth/toptoplevel/top_level_LiTE_DTU/Selection_TMR/rd_ptr_A
add wave -noupdate /tb_LDTU_presynth/toptoplevel/top_level_LiTE_DTU/Selection_TMR/ref_sat_A
add wave -noupdate /tb_LDTU_presynth/toptoplevel/top_level_LiTE_DTU/Selection_TMR/gain_sel2_A
add wave -noupdate /tb_LDTU_presynth/toptoplevel/top_level_LiTE_DTU/Selection_TMR/gain_sel_A
add wave -noupdate /tb_LDTU_presynth/toptoplevel/top_level_LiTE_DTU/Selection_TMR/decision2_A
add wave -noupdate /tb_LDTU_presynth/toptoplevel/top_level_LiTE_DTU/Selection_TMR/dout_g1_A
add wave -noupdate /tb_LDTU_presynth/toptoplevel/top_level_LiTE_DTU/Selection_TMR/dout_g10_A
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {661440000 ps} 0} {{Cursor 2} {319056 ps} 1} {{Cursor 3} {28728960000 ps} 0}
...
update
WaveRestoreZoom {588626362 ps} {811124929 ps}
